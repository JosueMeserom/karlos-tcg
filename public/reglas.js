...
<div class="rule-section">
    ...
    <div class="widget-box">
        ...
        <div style="flex:1; display:flex; flex-direction:column; justify-content:center; color:#cbd5e1; font-size:0.9rem;">
            ...
            <div style="margin-top: 8px; color:#94a3b8;">Un estado alterado dura los turnos que diga su contador, y <b>ese contador baja al TERMINAR el turno del jugador dueño de la carta</b> (los turnos del rival no lo gastan). La excepción es el <b>Daño por tiempo</b>, que va al revés: golpea al <b>inicio</b> del turno de su dueño y baja justo después de cada golpe, así que "3 turnos" son exactamente 3 golpes.</div>
            <div style="margin-top: 10px; border-top: 1px dashed #475569; padding-top: 5px;">🧊 <b>Estasis:</b> No puede ser objetivo de NINGÚN ataque, ni normal ni especial, y es inmune al daño y a los efectos de cualquier carta. A cambio está siempre agotada, no gana Furor, y no te hace de muro: si es tu único aliado, el rival puede atacarte directamente.</div>
            <div style="margin-top: 10px; border-top: 1px dashed #475569; padding-top: 5px;">👁️ <b>Oculto:</b> No puede ser objetivo DIRECTO de ataques normales. La clave es ELEGIR: el Oculto protege de que te SEÑALEN, así que un ataque que alcance a toda una fila sin elegir objetivo sí le llega, y un ataque que impone una regla -una venganza obligada- también. Quien tenga sus ataques normales convertidos en especiales puede señalarlo igualmente.
