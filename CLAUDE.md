...
- **Un visor de pila SIEMPRE se puede cerrar sin elegir** (§12.bis de la rúbrica): abrirlo no cambia el tablero. Pero cancelar una búsqueda en el MAZO **sí baraja** — mirarlo lo revuelve, se coja algo o no.
