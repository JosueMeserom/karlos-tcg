...
const escenarios = [
    ...
    },
    {
        ...
        logsIntencionados: [
            { de: 'se activa! Goodman', a: 'se activa! Goodman de J2 (Jugador 2)', motivo: 'NORMA DEL PROYECTO aplicada al {carta} del DSL (14-ago-2026): un log que nombra una carta dice de quien es, con el formato de siempre. La vieja usaba el nombre pelado. Mismo mensaje, nombre completo' },
    ...
    },
    {
        ...
        logsIntencionados: [
            { de: '[system] Goodman', a: '[system] Goodman de J2 (Jugador 2)', motivo: 'NORMA DEL PROYECTO aplicada al {carta} del DSL (14-ago-2026): un log que nombra una carta dice de quien es, con el formato de siempre. La vieja usaba el nombre pelado. Mismo mensaje, nombre completo' },],
    },
    {
