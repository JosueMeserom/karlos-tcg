...
const escenarios = [
    ...
    },
    {
        ...
        logsIntencionados: [
            { de: 'usa 1 Furor de Mini-tigre y', a: 'usa 1 Furor de Mini-tigre (J1 (Jugador 1)) y',
    ...
    },
    {
        ...
        logsIntencionados: [
            { de: 'usa 1 Furor de Oso con armadura y cura', a: 'usa 1 Furor de Oso con armadura (J1 (Jugador 1)) y cura',
              motivo: 'norma del proyecto (logs en 3ª persona con dueño): la vieja logueaba payer.name a secas; la nueva usa getCardNameWithOwner vía DSL._nombre' },
        ],
    },
    {
        ...
        logsIntencionados: [
            { de: 'a Mini-tigre y consume', a: 'a Mini-tigre (J1 (Jugador 1)) y consume',
